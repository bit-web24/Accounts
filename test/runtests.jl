...
# !!! Main.UserApp is configured as an alias for Main.Accounts and you might encounter it in some tests
using Main.Accounts, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Accounts tests" begin
  @includetests ARGS
end
